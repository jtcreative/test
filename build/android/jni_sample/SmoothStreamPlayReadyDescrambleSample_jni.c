...
static unsigned long SmoothStreamPlayReadyDescrambleCallbackFunc(
											...
											void*			pUserData)
{
	LOGI("[	SmoothStreamPlayReadyDescrambleCallbackFunc ] inputBuffer:0x%x(%d), outputBuffer:0x%X, pSampleEncBox:0x%X(%d), SampleIDX(%d), TrackID(%d), UserData:0x%X \n",
...
jint Java_com_nextreaming_smoothstreamplayreadydescramblesample_SmoothStreamPlayReadyDRMManager_initDRMManager (JNIEnv * env, 
														   	   jobject clazz,
														   	   jstring libName)
{
